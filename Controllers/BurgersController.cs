...
using BurguerCF.Data;
using JavierVarela_EjercicioCF.Models;

namespace JavierVarela_EjercicioCF.Controllers
{
    public class BurgersController : Controller
    {
        private readonly BurgerCFContext _context;

        public BurgersController(BurgerCFContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'BurgerCFContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BurgerCFContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
